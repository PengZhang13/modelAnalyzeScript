...
def runSinglePFR(T_0, pressure, composition_0, length, v_0, d, tempProfile, factor, reactionIndex):
    ...
    return [gas2.reaction_equation(reactionIndex-1), r2.thermo['C3H6'].X[0]*1.0e6]
...
def traverseFactor(T_0, pressure, composition_0, length, v_0, d, tempProfile, factorLgList, reactionIndex):
    moleFractionC3H6List = []
    factorList = [10**i for i in factorLgList]
    for i in range(len(factorList)):
        print "\n\n\n**************************\n***** Solving case %d in %d cases*****\n"%(i+1, len(factorList))
        temp = runSinglePFR(T, P, moleFraction, length, vFlowRate, d, tempProfile, factorList[i], reactionIndex)
        print temp
...
if __name__ == '__main__':
    ...
    tempProfile = '600.csv'
    targetMoleFractionFile = '600.txt'
    ...
    factorLgList = [float(i)/100 for i in range(-40, 0, 5)]

    [factorList, moleFractionC3H6List] = traverseFactor(T, P, moleFraction, length, vFlowRate, d, tempProfile, factorLgList, reactionIndex)
